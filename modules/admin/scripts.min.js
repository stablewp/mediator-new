...
function (module, exports, __webpack_require__) {
  var sweetalert = __webpack_require__(1);
  ...
  (function ($, undefined) {
    ...
    if (getUrlParameter('medpost') && getUrlParameter('medpost') != '' && getUrlParameter('action') == 'delete') {
      window.location.href = "admin.php?page=".concat(getUrlParameter('page'), "&delete=success");
    } // rm bookings on front


    function rmBooking(type, el, day, id) {
      // update parent json
      var booklist = JSON.parse($('#bk-calendar').attr('data-checker')),
          filterlist = [];
    ...
    var dprompt = $('a.delete-prompt'); // Rename move to trash with prompt

    if ($('body').hasClass('toplevel_page_med-bookings') || $('body').hasClass('med-calendar_page_med-calendars')) {
      dprompt = $('a.submitdelete');
      $('.submitdelete').html('Delete Booking').addClass('med-show'); // checkUpdate('.post-type-med-booking form#post')
    ...
    $(document).ready(function () {
      ...
      if ($('body').hasClass('med-calendar_page_med-import')) {
        var fileselect = document.querySelector('.bk-file-wrap input');
        fileselect.addEventListener('change', function (e) {
          if (fileselect.value == '') {
            ...
            if (fileselect.value.indexOf('.xlsx') < 0) {
              ...
              document.querySelector('.bk-file-text').innerHTML = "Document selected<br><span>".concat(fileselect.value.replace(/C:\\fakepath\\/i, ''), "</span>");
            }
          }
        });
      } // Delete prompt
                ...
                if (result.value) {
                  sweetalert.fire({
                    ...
                    $.ajax({
                      ...
                      url: btn.attr('href'),
                      success: function success(data) {
                        var theday = $(".bk-cals .bk-date[data-calendar-date=\"".concat(btn.attr('data-day'), "\"]")),
      ...
      if ($('.bk-deny').length) {
        $('.bk-deny').each(function () {
          $(this).click(function () {
              var link = $(this).closest('tr').find('.row-actions a.delete-prompt').attr('href');
              sweetalert.fire({
                  title: 'Are you sure you want <br>to delete/reject this item?',
                  text: "The item will be deleted permanantly and cannot be brought back.",
                  type: 'warning',
      ...
      if (lh.indexOf('post-new.php?post_type=med-booking') > -1 && lh.indexOf('auto_med_date') > -1 && lh.indexOf('auto_med_slot') > -1) {
        var slot = document.querySelector('div[data-name="booking_type"] select'),
      ...
      $('.move-select').each(function () {
        $(this).click(function () {
          var btn = $(this);
          var options = document.querySelectorAll('select[name="calendar-select"] option'),
              calendars = '';
          options.forEach(function (el) {
            if (!el.selected) {
              calendars += "\n\t\t\t\t\t\t  \t<li class=\"admin-move-listing\">\n\t\t\t  \t\t\t\t\t<span>".concat(el.innerHTML, "</span>\n\t\t\t  \t\t\t\t\t<a href=\"\">\n\t\t\t\t\t\t\t\t\t<label class=\"move-booking-btn\" data-url=\"").concat(btn.attr('data-url'), "\" data-postid=\"").concat(btn.attr('data-postid'), "\" data-id=\"").concat(el.value, "\">Move here</label>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t</li>");
            }
      ...
      if ($(".create-fields").length) {
        var count = $('.create-fields .field:not(.field-title)').length;
        var tcount = $('.create-fields .field.field-title').length;
        $('[addfield]').click(function (e) {
          ...
          if ($('.create-fields .field.field-title').length) {
            $('.create-fields .fields').append("<div class=\"field\"><div class=\"field-wrap\"><p sublabel>Form field</p><br><input type=\"text\" name=\"sf-form-".concat(count, "[]\" placeholder=\"Enter field name/title\"><div class=\"sf-typeselect\"><select name=\"sf-form-").concat(count, "[]\"><option disabled selected value=\"none\">Type</option><option value=\"text\">Text</option><option value=\"email\">Email</option><option value=\"number\">Number</option><option value=\"file\">File</option><option value=\"textarea\">Textarea</option></select></div><div class=\"removefield\">&times;</div><div class=\"bk-cal-loader la-ball-beat\"><div></div><div></div><div></div></div></div><div class=\"sf-form-required\"><input type=\"checkbox\" id=\"sf-required-").concat(count, "\" name=\"sf-required-").concat(count, "\" checked><label for=\"sf-required-").concat(count, "\">Required?</label></div><div class=\"sf-form-break\"><input type=\"checkbox\" id=\"sf-break-").concat(count, "\" name=\"sf-break-").concat(count, "\"><label for=\"sf-break-").concat(count, "\">Break line</label></div><div class=\"sf-form-border\"><input type=\"checkbox\" id=\"sf-border-").concat(count, "\" name=\"sf-border-").concat(count, "\"><label for=\"sf-border-").concat(count, "\">Bottom border</label></div><div class=\"sf-form-col\"><input type=\"checkbox\" id=\"sf-endcol-").concat(count, "\" name=\"sf-endcol-").concat(count, "\"><label for=\"sf-endcol-").concat(count, "\">Close column</label></div></div>"));
          } else {
            $('.create-fields .fields').append("<div class=\"field\"><div class=\"field-wrap\"><p sublabel>Form field</p><br><input type=\"text\" name=\"sf-form-".concat(count, "[]\" placeholder=\"Enter field name/title\"><div class=\"sf-typeselect\"><select name=\"sf-form-").concat(count, "[]\"><option disabled selected value=\"none\">Type</option><option value=\"text\">Text</option><option value=\"email\">Email</option><option value=\"number\">Number</option><option value=\"file\">File</option><option value=\"textarea\">Textarea</option></select></div><div class=\"removefield\">&times;</div><div class=\"bk-cal-loader la-ball-beat\"><div></div><div></div><div></div></div></div><div class=\"sf-form-required\"><input type=\"checkbox\" id=\"sf-required-").concat(count, "\" name=\"sf-required-").concat(count, "\" checked><label for=\"sf-required-").concat(count, "\">Required?</label></div><div class=\"sf-form-break\"><input type=\"checkbox\" id=\"sf-break-").concat(count, "\" name=\"sf-break-").concat(count, "\"><label for=\"sf-break-").concat(count, "\">Break line</label></div><div class=\"sf-form-border\"><input type=\"checkbox\" id=\"sf-border-").concat(count, "\" name=\"sf-border-").concat(count, "\"><label for=\"sf-border-").concat(count, "\">Bottom border</label></div></div>"));
          }
        });
        ...
        $(document, '.sf-typeselect').on('change', function (e) {
          if ($(e.target).parent().hasClass('sf-typeselect')) {
            if ($(e.target).val() == 'email') {
              $(e.target).parent().parent().parent().append("<div class=\"sf-form-primary\"><input type=\"checkbox\" id=\"sf-primary-".concat(count, "\" name=\"sf-primary-").concat(count, "\"><label for=\"sf-primary-").concat(count, "\">Send mail</label></div>"));
            } else {
...
function (module, exports, __webpack_require__) {
  ...
  */
  (function (global, factory) {
    true ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.Sweetalert2 = factory();
  })(this, function () {
    'use strict';
  ...
  if (typeof window !== 'undefined' && window.Sweetalert2) {
    window.Sweetalert2.version = '8.0.1';
